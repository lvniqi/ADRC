...
<img src="https://yuml.me/diagram/scruffy/class/[输入]->[过渡过程{bg:green}],[过渡过程]v1->[cut_1],[过渡过程]v2->[cut_2],[扩张状态观测器{bg:orange}]z1_n->[cut_1],[扩张状态观测器]z2_n->[cut_2],[cut_1]e1->[非线性组合],[cut_2]e2->[非线性组合{bg:red}],[非线性组合]u0->[cut_3],[cut_3]u->[对象],[对象]->[输出]，[输出]y->[扩张状态观测器],[cut_3]->[b0],[b0]->[扩张状态观测器],[扩张状态观测器]z3_n->[1/b0],[1/b0]->[cut_3]" >
